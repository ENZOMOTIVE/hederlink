...
export declare class AccountTransactionBuilder {
    /**
     *
     ...
     */
    static approveAssetAllowance(spenderAccount: AccountId | string, amount: number, issuerAccountId: AccountId | string, tokenId?: TokenId): BaseTransactionBuilder<AssetAllowanceResult>;
}
//# sourceMappingURL=account_transaction_builder.d.ts.map